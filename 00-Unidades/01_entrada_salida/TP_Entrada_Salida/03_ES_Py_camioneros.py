...
3.	Para el departamento de logística:
	...
	A.	Es necesario saber la cantidad camiones que harian falta para transportar los materiales que se utilizarán para la
    construcción de un edificio. Para ello, se ingresa la cantidad de toneladas necesarias de materiales a transportar. 
...
class App(customtkinter.CTk):
    ...
    def btn_cantidad_camiones_on_click(self):
        ...
        kilogramos = toneladas * num_a
        cantidad = kilogramos / num
        ...
        cant_camiones = "la cantidad de camiones que necesitas son {}".format(cantidad)
        alert("",cant_camiones)
        

    def btn_tiempo_llegada_on_click(self):
        kilómetros = float(self.txt_kilometros.get())
        velocidad = 90

        tiempo = kilómetros / velocidad

        tiempo_total = "el tiempo toltal que van a tardar es de {} h cada uno".format(tiempo)
        alert("",tiempo_total)
